...
final class SynonymModule implements ModuleInterface
{
    ...
    public function __construct(
        ...
        /**
         * @var array<string, string|string[]|bool|null>
         */
        public $options = [
            self::LANG_OPTION => 'en',
            self::HEADER_TEXT_OPTION => 'Look for synonyms',
            self::NO_RESULT_TEXT_OPTION => 'No Results for : {word}',
            ...
            self::PROVIDERS_OPTION => ['conceptnet', 'datamuse', 'freedictionary'],
