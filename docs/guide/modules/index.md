...
| **GalleryModule**    |          NO           | A media gallery to allow to pick images from a media gallery                                                                                                                                                                                     | mediaGallery  |    array     |                                       `listEndpoint`, `uploadEndpoint`, `searchEndpoint`, `icon`                                       |                               see ``Ehyiah\QuillJsBundle\DTO\Modules\GalleryModule``                                                                                                   |
