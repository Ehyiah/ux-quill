...
| **AdvancedTableModule**  |      YES      | Advanced Table module with Tiptap-like UI (add row/col buttons, context menu).                                                                                                                                                                                                                      | advanced-table | array | ``menus``, ``toolbar``, ``resize`` | see ``Ehyiah\QuillJsBundle\DTO\Modules\AdvancedTableModule`` |
