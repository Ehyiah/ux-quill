...
| **ImageSelectionModule** |      YES      | Automatically active with ImageField. Adds a blue border to the selected image and buttons to insert a paragraph before or after it.                                                                                                                                  | imageSelection | array | ``borderColor``, ``borderWidth``, ``buttonBeforeLabel``, ``buttonAfterLabel``, ``buttonBeforeTitle``, ``buttonAfterTitle`` | ['borderColor' => '#007bff', 'borderWidth' => '4px', 'buttonBeforeLabel' => '¶+', 'buttonAfterLabel' => '+¶', 'buttonBeforeTitle' => 'Insert a paragraph before', 'buttonAfterTitle' => 'Insert a paragraph after'] |
