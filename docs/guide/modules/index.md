...
| **ImageSelectionModule** |      YES      | Automatically active with ImageField. Adds a selection overlay with resize handles, alignment toolbar, paragraph insertion, rotation, flip, caption, alt text and link editing. | imageSelection | array | ``borderColor``, ``borderWidth``, ``buttonBeforeLabel``, ``buttonAfterLabel``, ``buttonBeforeTitle``, ``buttonAfterTitle``, ``alignLabels``, ``rotateLeftTitle``, ``rotateRightTitle``, ``flipHorizontalTitle``, ``flipVerticalTitle``, ``resetTitle``, ``linkTitle``, ``captionBackgroundColor`` | see ``Ehyiah\QuillJsBundle\DTO\Modules\ImageSelectionModule`` |
|    **ResizeModule**      |      YES      | (Legacy) Basic image resizing functionality using `quill-resize-image`. Use it if you prefer the old behavior over `ImageSelectionModule`. | resize | array | NONE | [] |
...
|   **SmartLinksModule**   |      NO       | [see details](./smart-links.md)                                                                                                                                                                                                                                     | smartLinks | array | ``linkRegex`` | ['linkRegex' => '/https?:\/\/[^\s]+/'] |
|    **CounterModule**     |      NO       | [see details](./counter.md) | counter | array | ``words``, ``words_label``, ``words_container``, ``characters``, ``characters_label``, ``characters_container`` | ['words' => true, 'words_label' => 'Number of words : ', 'words_container' => '', 'characters' => true, 'characters_label' => 'Number of characters : ', 'characters_container' => ''] |
...
|    **HtmlEditModule**    |      NO       | [see details](./html-edit.md)                                                                                                                                                                 | htmlEditButton | array | https://github.com/benwinding/quill-html-edit-button | see ``Ehyiah\QuillJsBundle\DTO\Modules\htmlEditButton`` | There is currently a conflict with tableField. Don't use both of them at the same time as the table inserted via the htmlEdit module will not be displayed |
...
| **LinkAttributesModule** |      NO       | Allows users to easily edit attributes of links, such as opening in a new tab or adding SEO attributes.                                                                                                                                                                                             | linkAttributes | array | `openInNewTabLabel`, `noFollowLabel`, `saveButtonLabel` | see ``Ehyiah\QuillJsBundle\DTO\Modules\LinkAttributesModule`` |
| **DividerModule** |      YES      | [see details](./divider.md) | divider | array | NONE | [] |
| **PasteSanitizerModule** |      YES      | [see details](./paste-sanitizer.md) | pasteSanitizer | array | `plain_text` | ['plain_text' => true] |
| **PageBreakModule** |      YES      | [see details](./pagebreak.md) | pageBreak | array | `label` | ['label' => 'Page Break'] |
