...
import { HtmlEditButton } from "./modules/htmlEditModule.js";
...
import InlineToolbar from "./modules/inlineToolbar.js";
Quill.register('modules/inlineToolbar', InlineToolbar);
import SlashModule from "./modules/slashModule.js";
...
Quill.register('modules/layout', Layout);
const icons = Quill.import('ui/icons');
if (icons) {
  icons['layout'] = '<svg viewBox="0 0 18 18"><rect class="ql-stroke" x="3" y="4" width="5" height="10" rx="1"/><rect class="ql-stroke" x="10" y="4" width="5" height="10" rx="1"/></svg>';
