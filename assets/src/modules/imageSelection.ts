...
export default class ImageSelection {
    ...
    private applyLayout(width: string, isBaseWidth = false) {
        if (!this.selectedImage) return;
    ...
    private getRotation(el: HTMLElement): number {
    ...
    private setRotation(el: HTMLElement, angle: number) {
