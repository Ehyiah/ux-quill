...
class TableCellBlot extends Container {
    ...
    static create(value: any) {
        const node = super.create(value) as HTMLTableCellElement;
    ...
    static formats(domNode: HTMLTableCellElement) {
        const formats: any = {};
    ...
    format(name: string, value: any) {
        if (name === 'table-cell') {
            if (value && typeof value === 'object') {
                const node = this.domNode as HTMLTableCellElement;
                if (value.row !== undefined) {
                    node.setAttribute('data-row', value.row);
                }
                if (value.col !== undefined) {
...
class TableRowBlot extends Container {
    ...
    static create(value: any) {
        const node = super.create(value) as HTMLTableRowElement;
    ...
    static formats(domNode: HTMLTableRowElement) {
        const formats: any = {};
